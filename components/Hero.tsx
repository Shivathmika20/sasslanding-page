       ...
       <div className='absolute bg-black h-[375px] w-[750px] sm:w-[1536px] sm:h-[768px] lg:w-[2500px] lg:h-[900px] rounded-[100%] left-1/2 -translate-x-1/2 border border-[#B48CDE] bg-[radial-gradient(closest-side,#000_82%,#9560EE)] top-[calc(100%-120px)] sm:top[calc(100%-200px)]'>
        ...
        <div className='mx-auto relative container p-4 flex flex-col justify-center items-center'>
            ...
            <div className='flex justify-center  mt-8 '>
              ...
              <motion.div className='absolute right-[480px] top-[80px] hidden sm:inline '
                drag
                dragSnapToOrigin>
                  <Image src={cursor} width={200} height={200} alt='cursor' className='max-w-none' draggable={false}/>
              </motion.div>
              <motion.div className='absolute left-[498px] top-14 hidden sm:inline'
                drag
                dragSnapToOrigin> 
                  <Image src={msg} width={200} height={200} alt='msg' className='max-w-none' draggable={false}/>
              </motion.div>
              </div>
            </div>
